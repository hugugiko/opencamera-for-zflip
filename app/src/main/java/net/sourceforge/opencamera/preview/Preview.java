...
public class Preview implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
    ...
    public Preview(ApplicationInterface applicationInterface, ViewGroup parent) {
        ...
        boolean using_texture_view = true;
        /*if( using_android_l ) {
    ...
    private void calculateCameraToPreviewMatrix() {
        ...
        camera_to_preview_matrix.postScale(-1, 1, cameraSurface.getView().getWidth() / 2f, cameraSurface.getView().getHeight() / 2f);
    }
    ...
    private void configureTransform() {
        ...
        // Apply mirroring flip to the camera buffer *before* display rotations (using preScale).
        // This ensures the horizontal flip is consistently applied to the source frame regardless of rotation.
        // Using postScale here previously caused a 180-degree offset in landscape due to coordinate system rotation.
        ...
        if( video_recorder != null ) { // check again, just to be safe
            ...
            try {
                ...
                if( this.camera_controller != null )
                    this.camera_controller.stopVideoRecorder();
            }
    ...
    private void startVideoRecording(final boolean max_filesize_restart) {
        ...
        if( info == null ) {
            ...
            try {
                ...
                camera_controller.initVideoRecorderPostPrepare(local_video_recorder, want_photo_video_recording, profile.videoFrameWidth, profile.videoFrameHeight, getImageVideoRotation());
